package app.banafsh.android.ui.modifier
...
private fun Modifier.fadingEdge(start: Boolean, middle: Int, end: Boolean, alpha: Float, isHorizontal: Boolean) = this
...
fun Modifier.verticalFadingEdge(top: Boolean = true, middle: Int = 3, bottom: Boolean = true, alpha: Float = 1f) =
    fadingEdge(start = top, middle = middle, end = bottom, alpha = alpha, isHorizontal = false)

fun Modifier.horizontalFadingEdge(left: Boolean = true, middle: Int = 3, right: Boolean = true, alpha: Float = 1f) =
