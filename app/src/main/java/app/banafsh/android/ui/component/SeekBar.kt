...
private fun ContentDrawScope.drawScrubber(range: ClosedRange<Long>, position: Long, color: Color, height: Dp) {
...
@Composable
private fun Duration(position: Long, duration: Long, show: Boolean) = AnimatedVisibility(
    visible = show,
